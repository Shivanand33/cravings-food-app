...
const EditRestaurantProfileModal = ({ onClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    gender: getStringVal(user?.gender),
    dob: getStringVal(user?.dob),
    address: getStringVal(user?.address),
    city: getStringVal(user?.city),
    pin: getStringVal(user?.pin),
    restaurantName: getStringVal(user?.restaurantName),
    cuisine: getStringVal(user?.cuisine),
    operatingStatus: getStringVal(user?.operatingStatus) || "open",
    documents: {
      gst: getStringVal(user?.documents?.gst),
      fssai: getStringVal(user?.documents?.fssai),
